...
Video Demonstration: https://drive.google.com/file/d/15TsQa1BfdTtDis91AfXKLp9mm9tY5hJL/view?usp=sharing
## Features
...
## Quick Start
```bash
git clone https://github.com/AkashMummidi/ResolveNow_Your-Platform-for-Online-Complaints.git
